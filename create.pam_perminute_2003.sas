...
libname xptfile xport "Z:\OneDrive - McGill University\goldstein\paxraw_c.xpt" access=readonly;
...
data myfolder.pam_perminute_2003;
  set pam_perminute;
run;

proc contents data=myfolder.pam_perminute_2003;
run;
