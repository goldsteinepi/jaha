...
* libname demo xport "W:\goldstein\2003\demo_c.xpt";* Added by kwd;
...
*  merge myfolder.pam_perminute(in=in_pam) myfolder.demo_c(in=in_demog keep=seqn ridageyr);
  merge myfolder.pam_perminute_2003(in=in_pam) demo.demo_c(in=in_demog keep=seqn ridageyr);* Added by kwd;
  by seqn;
  if in_pam;
...
proc contents data=myfolder.pam_perday_2003;
run;
